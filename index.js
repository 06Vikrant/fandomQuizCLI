...
let questionOne = {
    question: "1. Who does Goku and Krillin train with when they was kids? \n A. King Kai \n B. Master Roshi \n C.  Mr. PoPo \n D. None",
    answer: "B"
}
let questionTwo = {
    question: "2.   What is actually manga? \n A.  A form of comics  \n B. A form of animation \n C. A form of video game \n D. None",
    answer: "B"
}
let questionThree = {
    question: "3. How to run like Naruto, the main character in the anime of the same name? \n A. Put your arms back and head forward \n B. Put your right hand out, left foot in \n C. South Put your left hand out, right foot in \n D. None",
    answer: "A"
}
let questionFour = {
    question: "4. What is the meaning of Deku, the nickname of Izuku Midoriya in the anime My Hero Academia? \n A. A person who cannot do anything \n B. A nerd who loves playing game \n C.  A good friend \n D. None",
    answer: "A"
}
let questionFive = {
    question: "5. Which of the following rules is NOT true about the Death Note? \n A. Once you have written down the name of the victim and other conditions, the death will happen even when the note is destroyed \n B. You can’t kill those people who only have fewer than 5 minutes of their life left \n C. The spell will not affect a person whose name has been spelt wrongly 4 times \n D. None ",
    answer: "B"
}
...
for (let i = 0; i < topScorers.length; i++) {
    let currentHighScore = topScorers[i];
